                ...
                <tbody>
                    @foreach ($tb_wali as $data)
                        <tr>
                          ...
                          <td>{{ $data->alamat }}</td>
                          <td>
                            <a href="/datawaliedit/{{ $data->id_wali }}" type="button" class="btn btn-primary">Ubah</a>
                            <a href="/datawalidelete/{{ $data->id_wali }}" type="button" class="btn btn-danger">Hapus</a>
                          </td>
                        </tr>
                    @endforeach
                </tbody>
