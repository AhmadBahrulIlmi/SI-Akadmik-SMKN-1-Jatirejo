              ...
              <tbody>
                  @foreach ($tb_guru as $data)
                      <tr>
                        ...
                        <td>{{ $data->jabatan }}</td>
                        <td>
                          <a href="/dataguruedit/{{ $data->id_guru }}" type="button" class="btn btn-primary">Ubah</a>
                          <a href="/datagurudelete/{{ $data->id_guru }}" type="button" class="btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                  @endforeach
              </tbody>
