          ...
          <table class="table ">
              ...
              <tbody>
                  @foreach ($tb_admin as $data)
                      <tr>
                        <th scope="data">{{ $data->id_admin }}</th>
                        <td>{{ $data->nama }}</td>
                        <td>{{ $data->no_telp }}</td>
                        <td>{{ $data->alamat }}</td>
                        <td>
                          <a href="/dataadminedit/{{ $data->id_admin }}" type="button" class="btn btn-primary">Ubah</a>
                          <a href="/dataadmindelete/{{ $data->id_admin }}" type="button" class="btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                  @endforeach
              </tbody>
