          ...
          <table class="table ">
              ...
              <tbody>
                  @foreach ($tb_mapel as $data)
                      <tr>
                        <th scope="data">{{ $data->id_mapel }}</th>
                        <td>{{ $data->nama_mapel }}</td>
                        <td>
                          <a href="/datamapeledit/{{ $data->id_mapel }}" type="button" class="btn btn-primary">Ubah</a>
                          <a href="/datamapeldelete/{{ $data->id_mapel }}" type="button" class="btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                  @endforeach
              </tbody>
