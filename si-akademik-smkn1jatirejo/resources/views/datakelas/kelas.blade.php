          ...
          <table class="table ">
              ...
              <tbody>
                  @foreach ($tb_kelas as $data)
                      <tr>
                        <th scope="data">{{ $data->id_kelas }}</th>
                        <td>{{ $data->tingkat_kelas }}</td>
                        <td>{{ $data->tb_datajurusan->nama_jurusan}}</td>
                        <td>
                          <a href="/datakelasedit/{{ $data->id_kelas }}" type="button" class="btn btn-primary">Ubah</a>
                          <a href="/datakelasdelete/{{ $data->id_kelas }}" type="button" class="btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                  @endforeach
              </tbody>
