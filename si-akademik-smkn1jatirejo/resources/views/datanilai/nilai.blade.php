              ...
              <tbody>
                  @foreach ($tb_nilai as $data)
                      <tr>
                        ...
                        <td>{{ $data->uas }}</td>
                        <td>
                          <a href="/datanilaiedit/{{ $data->id_nilai }}" type="button" class="btn btn-primary">Ubah</a>
                          <a href="/datanilaidelete/{{ $data->id_nilai }}" type="button" class="btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                  @endforeach
              </tbody>
