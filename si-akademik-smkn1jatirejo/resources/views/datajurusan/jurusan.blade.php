          ...
          <table class="table ">
              ...
              <tbody>
                  @foreach ($tb_jurusan as $data)
                      <tr>
                        <th scope="data">{{ $data->id_jurusan }}</th>
                        <td>{{ $data->nama_jurusan }}</td>
                        <td>
                          <a href="/datajurusanedit/{{ $data->id_jurusan }}" type="button" class="btn btn-primary">Ubah</a>
                          <a href="/datajurusandelete/{{ $data->id_jurusan }}" type="button" class="btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                  @endforeach
              </tbody>
